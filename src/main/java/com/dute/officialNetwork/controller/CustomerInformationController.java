...
import com.dute.officialNetwork.api.request.index.CustomerInformationRequest;
...
public class CustomerInformationController {
	...
	@ApiOperation("存储客户信息")
	@PostMapping("/save")
	public ResultData<Void> commitInfo(CustomerInformationRequest cir, HttpServletRequest request) {
